...
public class App {
	...
	static{
    	...
    	documentos.add(new DocumentByUploadDTO(encodeFileToBase64Binary("C:\\Digitalizacion\\JPG_400K_1.jpg"), "JPG", "1"));
//		documentos.add(new DocumentByUploadDTO(encodeFileToBase64Binary("C:\\Digitalizacion\\PDF_1M_1.pdf"), "PDF", "2"));
//		documentos.add(new DocumentByUploadDTO(encodeFileToBase64Binary("C:\\Digitalizacion\\PNG_1M_1.png"), "PNG", "3"));
//		documentos.add(new DocumentByUploadDTO(encodeFileToBase64Binary("C:\\Digitalizacion\\PDF_1M_4.pdf"), "PDF", "4"));
...
//					"https://201.151.234.138:8580/facadeService/v1/facadeProcess/getProcess", //prod
					"d69527a8c3d46df5a922101baef39682ea51431f");
